...
# 輸入前面產生的 privatekey as SERVER_PRIVATE_KEY
[Interface]
...
# Add client (Please set client first, you will got public key)
CLIENT_PUBLIC_KEY=
sudo wg set wg0 peer ${CLIENT_PUBLIC_KEY} allowed-ips 10.140.0.20
